...
--
-- Servidor: localhost
-- Tiempo de generación: 15-03-2018 a las 07:58:20
...
(11, 3, 'Samsung 65 pulgadas UHD Televisión', 1, 'Samsungtele.jpg', 127, 'SAMSUNG'),
(12, 2, 'Ordenador sobremesa Gamming', 2, '', 123, 'GAMMING ');
...
(6, 'Rafa', 'Caro Ruiz', 'rafa@hotmail.com', 'Tengo problemas con la compra que hice de un raton que no me funciona.');
...
(1, 'Aaron1234@hotmail.com', '2', 'Aaronsee', '1bbd886460827015e5d605ed44252251', 'Morenos Capuello', 1, '', 600443349, '44194769W', 933357685),
...
(8, 'Martinez@hotmail.com', '2', 'Maria Jose', '1bbd886460827015e5d605ed44252251', 'Martinezi Martinez', 1, '', 934565678, '45678986V', 934567876),
(9, 'c-sanchezjulian@hotmail.com', '2', 'Carmen', '7982479ee34ad16b3780988c0ee0ed40', 'Luque Sanchez', 1, '', 657895323, '46567893Y', 933354628);
...
--
ALTER TABLE `tbl_mensajes`
  MODIFY `id_mensajes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
